...
fn build_number() -> Result<(), Box<dyn Error>> {
    let content = reqwest::blocking::get(
        "https://raw.githubusercontent.com/Calastrophe/cs2-dumper/main/output/info.json",
    )
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    download(
        "https://raw.githubusercontent.com/Calastrophe/cs2-dumper/refs/heads/main/output/client_dll.rs",
        format!("{path}/client_module.rs"),
    )
    .expect("Failed to download build file \"client.dll.rs\"");

    download(
        "https://raw.githubusercontent.com/Calastrophe/cs2-dumper/refs/heads/main/output/offsets.rs",
        format!("{path}/offsets.rs"),
    )
    .expect("Failed to download build file \"offsets.rs\"");

    download(
        "https://raw.githubusercontent.com/Calastrophe/cs2-dumper/refs/heads/main/output/engine2_dll.rs",
